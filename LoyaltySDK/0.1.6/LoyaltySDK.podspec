Pod::Spec.new do |spec|
	...
	spec.source = {
		:http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/35903183',
		:type => 'zip',
		:headers => [
	...
	spec.subspec 'Component' do |ui|
		...
		ui.dependency 'Apollo'
		ui.dependency 'ApolloTheme', '0.0.1-alpha'
	end

	spec.subspec 'Model' do |model|
		model.vendored_frameworks = 'LoyaltyModel.framework'
		
		model.dependency 'TekCoreNetwork'
	end
