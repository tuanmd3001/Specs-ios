Pod::Spec.new do |s|
	...
	s.source                 = { :http => 'https://github.com/teko-vn/Specs-ios/releases/download/TripiFlightKit-v0.0.5-dev/TripiFlightKit.framework.zip' }
	...
	s.dependency 'TripiCommon', '0.0.3'
