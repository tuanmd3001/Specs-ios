Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/79484846',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'ShopFrontWebCoreSDK', '~> 0.1.1-alpha.1'
