Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/49073819',
                           :type => 'zip',
                           :headers => [
    ...
    # dependency
    s.dependency 'OrderCore', '~> 0.13.0-alpha1'
    ...
    s.dependency 'HermesExtension', '~> 1.0'
  end
