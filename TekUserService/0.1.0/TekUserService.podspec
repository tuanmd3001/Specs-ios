...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.homepage         = 'https://github.com/tungnx-teko/TekUserServiceDistribution.git'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'tungnx-teko' => 'tung.nx@teko.vn' }
    s.source           = { :git => 'https://' + ENV['GITHUB_USER_TOKEN'] + '@github.com/tungnx-teko/TekUserServiceDistribution.git', :tag => s.version.to_s }
