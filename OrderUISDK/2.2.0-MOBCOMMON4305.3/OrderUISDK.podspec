Pod::Spec.new do |s|
    s.name             = 'OrderUISDK'
    s.version          = '2.2.0-MOBCOMMON4305.3'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/102245794',
                           :type => 'zip',
                           :headers => [
    ...
    ## otherPods
    s.dependency 'ShopFrontWebCoreSDK', '~> 0.1.3-MOBCOMMON4305.2'
