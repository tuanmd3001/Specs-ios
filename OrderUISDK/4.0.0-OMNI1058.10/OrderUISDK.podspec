Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/136640363',
                           :type => 'zip',
                           :headers => [
    ...
    ## corePods
    s.dependency 'OrderCoreSDK', '~> 4.0.0-OMNI1058.5'
    ...
    ## otherPods
    s.dependency 'ShopFrontWebCoreSDK', '~> 0.1.3'
