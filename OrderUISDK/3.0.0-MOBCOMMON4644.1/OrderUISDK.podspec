Pod::Spec.new do |s|
    s.name             = 'OrderUISDK'
    s.version          = '3.0.0-MOBCOMMON4644.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/102532311',
                           :type => 'zip',
                           :headers => [
    ...
    ## corePods
    s.dependency 'OrderCoreSDK', '~> 3.0.0-MOBCOMMON4644.1'
