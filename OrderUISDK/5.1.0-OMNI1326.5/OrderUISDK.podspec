Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/182714149',
                           :type => 'zip',
                           :headers => [
    ...
    ## corePods
    s.dependency 'OrderCoreSDK', '5.1.0-OMNI1326.1'
    ...
    ## otherPods
    s.dependency 'ShopFrontWebCoreSDK', '1.1.0-OMNI1326.1'
