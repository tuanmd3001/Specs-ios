...
Pod::Spec.new do |s|
  ...
  #   * Finally, don't worry about the indent, CocoaPods strips it!
    ...
    s.description      = <<-DESC
  This version includes Alamofire built as static framework. However, we still need dependency to avoid conflict version.
                         DESC
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/29180938',
                           :type => 'zip',
                           :headers => [
