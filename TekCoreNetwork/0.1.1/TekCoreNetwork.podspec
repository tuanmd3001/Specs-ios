...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.homepage         = 'https://github.com/linhvt-teko/TekCoreNetwork-Distribution.git'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'linhvt-teko' => 'linh.vt@teko.vn' }
    s.source           = { :git => 'https://' + ENV['GITHUB_USER_TOKEN'] + '@github.com/linhvt-teko/TekCoreNetwork-Distribution.git', :tag => s.version.to_s }
