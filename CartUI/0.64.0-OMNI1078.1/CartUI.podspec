...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/111470555',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.64.0-OMNI1078.1'
  ...
  s.dependency 'TekAutomationTestContract', '0.1.0-OMNI1078.1'
