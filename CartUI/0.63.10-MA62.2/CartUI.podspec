...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/111710171',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.63.10-MA62.2'
  ...
  # Tracker
  s.dependency 'TekoTracker', '~> 1.9.1-MA62.4'
  s.dependency 'SwiftFootprint', '~> 1.6.1-MA62.2'
