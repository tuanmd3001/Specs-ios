...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/141921223',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '1.7.0-OMNI1289.4'
  ...
  # Tracker
  s.dependency 'TekoTracker', '2.0.0-OMNI1289.2'
