...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '0.64.1-MOBCOMMON5040.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/114349752',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.64.1-MOBCOMMON5040.1'
