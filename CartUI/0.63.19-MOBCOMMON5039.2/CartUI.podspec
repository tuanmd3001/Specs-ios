...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '0.63.19-MOBCOMMON5039.2'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/114804974',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.63.19-MOBCOMMON5039.2'
