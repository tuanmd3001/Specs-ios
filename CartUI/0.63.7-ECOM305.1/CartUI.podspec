...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/91377743',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.63.7-ECOM305.1'
  ...
  # Apollo
  s.dependency 'Apollo', '3.2.0-ECOM305.2'
  s.dependency 'ApolloTheme' , '~> 1.0'

  # Tracker
  s.dependency 'TekoTracker', '~> 1.6'
