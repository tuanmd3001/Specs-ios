...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/70255153',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.61.0-beta.1'
  ...
  # Loyalty
  s.dependency 'LoyaltyComponent', '~> 1.5'
