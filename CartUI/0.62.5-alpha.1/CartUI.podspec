...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/76394190',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '0.62.5-alpha.1'
  ...
  # Loyalty
  s.dependency 'LoyaltyComponent', '~> 2.0'
