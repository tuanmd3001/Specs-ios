...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/141788666',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '1.7.0-OMNI1289.3'
  ...
  # Tracker
  s.dependency 'TekoTracker', '1.14.0-OMNI1289.1'
