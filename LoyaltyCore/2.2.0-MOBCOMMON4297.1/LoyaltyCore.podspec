Pod::Spec.new do |s|
    s.name             = 'LoyaltyCore'
    s.version          = '2.2.0-MOBCOMMON4297.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/90700638',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyModel', '2.2.0-MOBCOMMON4297.1'
