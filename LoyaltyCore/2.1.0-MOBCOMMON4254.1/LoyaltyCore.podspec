Pod::Spec.new do |s|
    s.name             = 'LoyaltyCore'
    s.version          = '2.1.0-MOBCOMMON4254.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/89220326',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyModel', '2.1.0-MOBCOMMON4254.1'
