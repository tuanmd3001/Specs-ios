...
TODO: Add long description of the pod here.
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/28218935',
                         :type => 'zip',
                         :headers => [
  ...
  s.dependency 'TekServiceInterfaces', '~> 0.2.40'
  s.dependency 'Janus', '1.2.4'
  s.dependency 'Minerva', '1.2.5'
