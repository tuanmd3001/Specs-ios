...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = { :git => 'https://' + ENV['GITHUB_USER_TOKEN'] + '@github.com/linhvt-teko/TekPageBuilderService-Distribution.git', :tag => s.version.to_s }
    ...
    s.vendored_frameworks = 'TekPageBuilderService.framework'
  
    s.public_header_files = 'TekPageBuilderService.framework/Headers/*.h'
    s.source_files = 'TekPageBuilderService.framework/Headers/*.{h, m, swift}'
    s.name = "TekPageBuilderService"
