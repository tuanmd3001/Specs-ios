...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
                         DESC
    s.homepage         = 'https://huylv-teko:' +ENV['GITHUB_TOKEN'] +'@github.com/teko-vn/Specs-ios.git'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { '$(git config user.name)' => '$(git config user.email)' }
    s.source           = { :git => 'https://gitlab-ci-token:xvRZVdtxj4EHK-WGawzo@git.teko.vn/data/footprint/footprint-dto.git', :tag => 'v'+ENV['VERSION'] }
