Pod::Spec.new do |s|
    s.name             = 'DiscoveryUI'
    s.version          = '3.6.0-MOBCOMMON5867.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/148897428',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '6.2.0-MOBCOMMON5867.1'
