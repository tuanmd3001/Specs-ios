Pod::Spec.new do |s|
    s.name             = 'DiscoveryUI'
    s.version          = '2.11.0-MOBCOMMON5087.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/124612256',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '5.2.0-MOBCOMMON5357.1'
