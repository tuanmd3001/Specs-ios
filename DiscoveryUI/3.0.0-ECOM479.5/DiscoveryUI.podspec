Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/127220931',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'ShopFrontWebCoreSDK', '0.2.0-ECOM479.6'
    #realm
    ...
    s.dependency 'TekDiscoveryEvent', '~> 5.4.0-ECOM348'
