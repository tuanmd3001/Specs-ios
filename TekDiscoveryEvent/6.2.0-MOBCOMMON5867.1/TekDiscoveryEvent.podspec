Pod::Spec.new do |s|
    ...
    s.version          = '6.2.0-MOBCOMMON5867.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/147470176',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '3.5.0-MOBCOMMON5867.1'
    s.dependency 'TekPpmService', '~> 2.10'
    s.dependency 'TekTempiService', '0.3.0-MOBCOMMON5867.1'
