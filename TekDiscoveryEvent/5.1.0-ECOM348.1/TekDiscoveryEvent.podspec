Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/119531964',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekPolicyService', '~> 3.4'
    s.dependency 'TekSearchService', '~> 3.2'
    s.dependency 'TekDiscoveryCore', '3.1.0-ECOM348.1'
    s.dependency 'TekPpmService', '~> 2.10'
    s.dependency 'TekTempiService', '0.2.0-ECOM348.1'
