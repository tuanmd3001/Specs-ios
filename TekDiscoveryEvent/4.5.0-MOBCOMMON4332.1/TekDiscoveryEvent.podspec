Pod::Spec.new do |s|
    ...
    s.version          = '4.5.0-MOBCOMMON4332.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/93581776',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '2.3.0-MOBCOMMON4332.1'
