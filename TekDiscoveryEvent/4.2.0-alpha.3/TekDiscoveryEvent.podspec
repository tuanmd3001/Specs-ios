Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/84119642',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekPolicyService', '~> 3.4.0-alpha.1'
    s.dependency 'TekSearchService', '~> 3.2.0'
    s.dependency 'TekDiscoveryCore', '~> 2.0.3-alpha.1'
    s.dependency 'TekPpmService', '~> 2.10.0'
    s.dependency 'TekTempiService', '~> 0.1.0-alpha.1'
