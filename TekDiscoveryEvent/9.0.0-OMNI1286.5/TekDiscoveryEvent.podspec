Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/177650576',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '5.2.0-OMNI1286.1'
    s.dependency 'TekPpmService', '3.1.0-OMNI1286.4'
