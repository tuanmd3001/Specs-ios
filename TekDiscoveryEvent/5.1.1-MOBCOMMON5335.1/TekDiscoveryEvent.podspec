Pod::Spec.new do |s|
    ...
    s.version          = '5.1.1-MOBCOMMON5335.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/123738445',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekPolicyService', '3.4.3-MOBCOMMON5335.1'
    s.dependency 'TekSearchService', '~> 3.2'
    s.dependency 'TekDiscoveryCore', '~> 3.0'
