Pod::Spec.new do |s|
    ...
    s.version          = '4.7.0-MOBCOMMON4820.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/109756153',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '~> 2.4'
    s.dependency 'TekPpmService', '2.10.1-MOBCOMMON4820.2'
