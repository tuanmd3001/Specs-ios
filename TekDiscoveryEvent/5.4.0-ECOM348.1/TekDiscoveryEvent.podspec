Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/126122815',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '3.3.0-ECOM348.1'
    s.dependency 'TekPpmService', '~> 2.10'
    s.dependency 'TekTempiService', '0.2.0-ECOM348.3'
