Pod::Spec.new do |s|
    ...
    s.version          = '4.6.0-MOBCOMMON4000.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/99329028',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '2.4.0-MOBCOMMON4000.2'
