Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/47891203',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekPolicyService', '~> 3.2.0'
    s.dependency 'TekSearchService', '~> 3.2.0'
    s.dependency 'TekDiscoveryCore', '~> 1.0.1'
    s.dependency 'TekPpmService', '~> 2.7.0'
