Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/154124020',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '3.5.0-ECOM480.1'
    s.dependency 'TekPpmService', '~> 2.10'
    s.dependency 'TekTempiService', '0.3.0-ECOM480.1'
