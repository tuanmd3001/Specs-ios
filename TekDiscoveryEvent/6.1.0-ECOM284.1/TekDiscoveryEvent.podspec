Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/132043823',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekPolicyService', '4.1.0-ECOM284.1'
    s.dependency 'TekSearchService', '~> 3.2'
    s.dependency 'TekDiscoveryCore', '~> 3.3'
