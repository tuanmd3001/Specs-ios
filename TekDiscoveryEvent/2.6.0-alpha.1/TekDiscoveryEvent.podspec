Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/66093975',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekPolicyService', '~> 3.3.0'
    s.dependency 'TekSearchService', '~> 3.2.0'
    s.dependency 'TekDiscoveryCore', '~> 1.3'
    s.dependency 'TekPpmService', '~> 2.8.0'
    s.dependency 'TekCartService', '~> 0.1.0-alpha.2'
  end
