Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/162113462',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'Janus', '~> 3.11'
    s.dependency 'JanusFacebook', '~> 4.0'
    s.dependency 'JanusGoogle', '~> 3.5'
    s.dependency 'JanusApple', '~> 3.5'
    s.dependency 'Apollo', '4.0.0-CAR1804.1'
    s.dependency 'ApolloTheme', '1.0.1-CAR1806.1'
