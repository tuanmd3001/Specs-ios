Pod::Spec.new do |s|
    ...
    s.version          = '3.7.0-MOBCOMMON4804.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/108215841',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyCore', '2.3.1-MOBCOMMON4804.1'
