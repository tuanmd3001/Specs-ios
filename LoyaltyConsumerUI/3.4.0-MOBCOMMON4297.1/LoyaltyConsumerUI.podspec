Pod::Spec.new do |s|
    ...
    s.version          = '3.4.0-MOBCOMMON4297.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/90845206',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyCore', '2.2.0-MOBCOMMON4297.1'
