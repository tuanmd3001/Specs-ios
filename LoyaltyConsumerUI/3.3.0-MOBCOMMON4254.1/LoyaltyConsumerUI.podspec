Pod::Spec.new do |s|
    ...
    s.version          = '3.3.0-MOBCOMMON4254.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/89221448',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyCore', '2.1.0-MOBCOMMON4254.1'
