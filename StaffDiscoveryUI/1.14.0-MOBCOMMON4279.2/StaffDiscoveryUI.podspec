Pod::Spec.new do |s|
    ...
    s.version          = '1.14.0-MOBCOMMON4279.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/109906970',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '~> 4.6'
    s.dependency 'TekDiscoveryCore', '2.4.1-MOBCOMMON4279.1'
    s.dependency 'TekWmsService', '~> 0.0.2-MOBCOMMON4279.1'
    s.dependency 'TekLocalize', '~> 0.1'
    s.dependency 'TekBarcodeReader', '~> 0.1.0'
