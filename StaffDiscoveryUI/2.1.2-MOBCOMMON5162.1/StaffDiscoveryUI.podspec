Pod::Spec.new do |s|
    ...
    s.version          = '2.1.2-MOBCOMMON5162.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/123061280',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '~> 5.1.1-5162MOB5223'
