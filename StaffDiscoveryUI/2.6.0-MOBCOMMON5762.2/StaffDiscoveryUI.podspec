Pod::Spec.new do |s|
    ...
    s.version          = '2.6.0-MOBCOMMON5762.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/144968143',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '6.2.0-ECOM481.1'
