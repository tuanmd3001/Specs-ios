Pod::Spec.new do |s|
    ...
    s.version          = '2.2.0-MOBCOMMON5335.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/124916799',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '5.1.1-MOBCOMMON5335.1'
