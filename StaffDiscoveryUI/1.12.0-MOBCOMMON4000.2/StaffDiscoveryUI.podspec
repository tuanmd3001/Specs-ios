Pod::Spec.new do |s|
    ...
    s.version          = '1.12.0-MOBCOMMON4000.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/102116146',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '4.6.0-MOBCOMMON4000.1'
