Pod::Spec.new do |s|
    ...
    s.version          = '2.6.1-MOBCOMMON5997.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/156622413',
                           :type => 'zip',
                           :headers => [
