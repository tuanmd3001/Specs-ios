Pod::Spec.new do |s|
    ...
    s.version          = '1.9.1-MOBCOMMON4820.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/116484978',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '4.7.0-MOBCOMMON4820.2'
