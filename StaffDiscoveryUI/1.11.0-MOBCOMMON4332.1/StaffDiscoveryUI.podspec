Pod::Spec.new do |s|
    ...
    s.version          = '1.11.0-MOBCOMMON4332.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/91854077',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '4.5.0-MOBCOMMON4332.1'
    s.dependency 'TekWmsService', '~> 0.0'
    s.dependency 'TekLocalize', '~> 0.1'
    s.dependency 'Apollo', '~> 3.1'
