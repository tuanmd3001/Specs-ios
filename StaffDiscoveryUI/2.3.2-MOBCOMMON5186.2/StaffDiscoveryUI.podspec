Pod::Spec.new do |s|
    ...
    s.version          = '2.3.2-MOBCOMMON5186.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/137204367',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '6.0.1-MOBCOMMON5186.2'
