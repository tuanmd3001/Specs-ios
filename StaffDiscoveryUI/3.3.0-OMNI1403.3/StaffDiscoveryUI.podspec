Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/192340627',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '9.1.0-OMNI1403.1'
    s.dependency 'TekWmsService', '~> 1.0'
    s.dependency 'TekLocalize', '~> 1.0'
    s.dependency 'Apollo', '4.1.0-OMNI1403.2'
