...
Pod::Spec.new do |s|
    ...
    s.version          = '0.3.0'
    s.summary          = 'HestiaReactNative framework'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/59193842',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'HestiaReactNative.xcframework'

    # dependency
    s.dependency 'Hestia', '~> 2.14'
