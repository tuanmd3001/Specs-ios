...
Pod::Spec.new do |s|
  ...
  Pod::UI.puts "FirebaseFirestore: #{Dir.glob("TekoFirebaseFirestore/FirebaseFirestore/*.xcframework")}"
  Pod::UI.puts "FirebaseFirestore: #{Dir.glob("TekoFirebaseFirestore/FirebaseFirestore/Resources/*.bundle")}"
