...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/38944818',
                           :type => 'zip',
                           :headers => [
    ...
    s.public_header_files = 'ApolloTheme.framework/Headers/*.h'
    s.source_files = 'ApolloTheme.framework/Headers/*.{h, m, swift}'
