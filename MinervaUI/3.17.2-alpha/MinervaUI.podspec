...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/56242227',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'Minerva', '3.16.0-alpha'
    s.dependency 'Apollo', '~> 2.0'
    s.dependency 'LoyaltyComponent', '~> 1.3'
    s.dependency 'ApolloTheme', '~> 1.0'

    s.dependency 'VnpayWalletSDK', '~> 1.0.13'
    s.dependency 'SnapKit', '~> 5.0.1'
    s.dependency 'FittedSheets', '~> 1.4.6'
    s.dependency 'SkeletonView', '~> 1.21.2'
    s.dependency 'TerraUtilities', '~> 0.0.1'
