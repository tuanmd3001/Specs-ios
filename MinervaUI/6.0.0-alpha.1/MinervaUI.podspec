...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/69880856',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'Minerva', '~> 6.0.0-alpha.1'
    s.dependency 'Apollo', '~> 2.0'
    s.dependency 'LoyaltyComponent', '~> 2.0.0-alpha.2'
