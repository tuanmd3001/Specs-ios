...
Pod::Spec.new do |s|
  s.name             = 'TekoTracker'
  s.version          = '1.10.0-MOBCOMMON4897.1'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/teko-vn/Specs-ios.git'
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/108218732',
                           :type => 'zip',
                           :headers => [
  ...
  s.dependency 'SwiftFootprint', '1.7.0-MOBCOMMON4897.1'
